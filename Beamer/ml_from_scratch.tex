...
\note{\textbf{Throughout this section, add notes for each of the headers in the jupyter notebook!}\\\textbf{Also, do not forget to look over Lin alg for SVM notebook!}}

\frame{\tableofcontents[currentsection]}

\subsection{Representation}
\note{\textbf{Representation}\\}
\note{Definition of a hyperplane:\\
}
